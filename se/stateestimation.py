...
class VehicleState:
    ...
    def save_state(self):
        ...
        state_record = self.state_packer.pack(ts_nanoseconds, self.lcl_x, self.lcl_y, self.lcl_theta, self.glb_x, self.glb_y, self.glb_heading,
